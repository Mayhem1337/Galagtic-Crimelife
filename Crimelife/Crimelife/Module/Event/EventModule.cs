    ...
    class EventModule : Crimelife.Module.Module<EventModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            foreach (EventModel eventModel in equipList)
            {
                ...
                cb.SetData("MESSAGE", new Message("Benutze E um dein Geschenk zu abzuholen", "EVENT", "purple", 3000));
            ...
            try
            {
                ...
                try
                {
                    ...
                    dbPlayer.UpdateInventoryItems("Geschenk", 1, false);
                        ...
                        dbPlayer.SendNotification("Du hast dir dein Geschenk abgeholt. Lass es dir nicht abziehen!" + dbPlayer.Event, 3000, "purple","EVENT");
                    }
                }
                catch (Exception ex)
                {
