    ...
    internal class RathausModule : Module<RathausModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            foreach (Rathaus rathaus in RathausList)
            {
                ...
                ((Entity)val).SetData("MESSAGE", (object)new Message("Benutze E um mit dem Rathaus zu interagieren.", "RATHAUS", "purple"));
                  ...
                  try
                  {
                      if (!((Entity)(object)c == (Entity)null))
                      {
                          ...
                          if (player != null && player.IsValid(ignorelogin: true) && !((Entity)(object)player.Client == (Entity)null))
                          {
                              ...
                              {
                                  Title = "Name ändern",
                                  Message = "Gebe bitte deinen neuen Namen ein, im Anschluss wird dir der Betrag in Höhe von 1.000.000$ vom Staat entfernt. Beispiel: Vorname_Nachname",
                                  Callback = "changeName",
                                  CloseCallback = ""
                              });
                          }
