    ...
    internal class BusinessModule : Module<BusinessModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            try
            {
                ...
                //((Entity)val5).SetData("MESSAGE", (object)new Message("Benutze E um den Businesstower zu verlassen.", "BUSINESS", "purple"));   
            ...
            try
            {
                ...
                switch (selection)
                {
                    case "enter":
                        ...
                        {
                            player.SendNotification("Du bist aktuell nicht in einem Business!", 3000, "purple", "BUSINESS");
                            break;
                        }
                    ...
                    case "leave":
                        ...
                        player.Dimension = 0;
                        player.SendNotification("Du hast den Businesstower verlassen!", 3000, "purple", "BUSINESS");
                        break;
                    case "buy":
                        if (player.Business.Id != 0)
                        {
                            player.SendNotification("Du bereits in einem Business!", 3000, "purple", "BUSINESS");
                            break;
                        }
            ...
            try
            {
                ...
                if (player.Money >= 10000000)
                {
                    ...
                    if (flag)
                    {
                        ...
                        player.SendNotification("Business erfolgreich erstellt!", 3000, "purple", "BUSINESS");
        ...
        public void Acceptkrieg(Player c, string frakname)
        {
            ...
            try
            {
                //Notification.SendGlobalNotification("Die Fraktion " + dbPlayer.Faction.Name + " hat den Kriegsvertrag gegen die Fraktion " + fraktion.Name + " unterschrieben!", 8000, "purple", Notification.icon.bullhorn);
