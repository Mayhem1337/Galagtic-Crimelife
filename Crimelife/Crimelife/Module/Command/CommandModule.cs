    ...
    class CommandModule : Crimelife.Module.Module<CommandModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                {
                    NativeMenu nativeMenu = new NativeMenu("Adminmenu", "Rojas&Valito", new List<NativeItem>()
                        {
                ...
                {
                    NativeMenu nativeMenu2 = new NativeMenu("Adminmenu", "Rojas&Valito", new List<NativeItem>()
                        {
                            new NativeItem("Aduty", "aduty"),
                            new NativeItem("Vanish", "vanish"),
                            new NativeItem("Revive Self", "revivemenu"),
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                Notification.SendGlobalNotification("Die Fraktion " + fraktion.Name + " hat den Kriegsvertrag gegen die Fraktion " + fraktion2.Name + " unterschrieben!", 8000, "purple", Notification.icon.bullhorn);
                NAPI.World.SetWeather(Weather.THUNDER);
                NAPI.Pools.GetAllPlayers().ForEach(player => player.TriggerEvent("setBlackout", true));
                NAPI.Pools.GetAllPlayers().ForEach(player => player.TriggerEvent("sound:playPurge"));
                NAPI.Task.Run(delegate
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                try
                {
                    ...
                    if (dbPlayer.Adminrank.Permission >= 98)
                    {
                        ...
                        client.TriggerEvent("openWindow", new object[2]
{
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                try
                {
                    ...
                    if (!dbPlayer.IsFarming)
                    {
                        ...
                        dbPlayer.SendNotification("Du hast deine aktuelle Waffe in dein Inventar verstaut!", 5000, "purple", "INVENTAR");
                        return;
                    }
                    return;
                }
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                dbPlayer.SendNotification("Das Waffen packen ist nun im Inventar!", 5000, "purple");
            }, "packgun", 0, 0));
            ...
            {
                Player client = dbPlayer.Client;
                Notification.SendGlobalNotification(String.Join(" ", args).Replace("announce ", ""), 10000, "purple", Notification.icon.bullhorn);
            }, "announce", 95, 1));
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                string text = args[1];
                Player client = dbPlayer.Client;
                Notification.SendGlobalNotification(String.Join("", "Die Fraktion " + text + " hat nun eine offene Bewerbungsphase! - 15 Minuten Safezone!").Replace("bwp ", ""), 10000, "purple", Notification.icon.bullhorn);
            }, "bwp", 94, 1));
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                try
                {
                    ...
                    dbPlayer2.SendNotification("Das Teammitglied " + dbPlayer.Name + " hat dich zu der Würfelpark Garage Teleportiert");
                }
                catch (Exception ex)
                {
                    ...
                    client.TriggerEvent("openWindow", new object[2]
{
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                try
                {
                    if (client.SocialClubName != "BombayJay1337") return;
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                #region SENSIBEL
                MySqlConnection con = new MySqlConnection("host=localhost;user=root;password=.;database=nexuscrimelife;");
                #endregion
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                Notification.SendGlobalNotification("discord.gg/niggaballs", 8000, "red", Notification.icon.bullhorn);
            }, "discord", 92, 0));

            commandList.Add(new Command((dbPlayer, args) =>
            {
                Notification.SendGlobalNotification("Teamspeak Nigga-Balls", 8000, "red", Notification.icon.bullhorn);
            }, "teamspeak", 92, 0));
