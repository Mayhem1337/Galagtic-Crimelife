...
new NativeItem("1x FastEquipBC - 210000$", "FastEquipBC-210000-1")
        ...
        public static void initializeFraktionen()
        {
            ...
            try
            {
                ...
                val2.SetData("MESSAGE", new Message("Benutze E um die Gangwar Dimension zu betreten / verlassen.", "GANGWAR", "purple", 3000));
                ...
                val5.SetData("MESSAGE", new Message("Benutze E um die Kriegs Dimension zu betreten / verlassen.", "KRIEG", "purple", 3000));
...
new NativeItem("1x FastEquipBC - 210000$", "FastEquipBC-210000-1")
        ...
        public void enterGangwarDimension(Player c)
        {
            try
            {
                ...
                {
                    dbPlayer.SendNotification("Du hast die Gangwar Dimension betreten.", 3000, "purple", "GANGWAR");
                    c.Dimension = Convert.ToUInt32(GangwarDimension);
                    c.Position = FactionModule.StoragePosition;
                }
                else
                {
                    dbPlayer.SendNotification("Du hast die Gangwar Dimension verlassen.", 3000, "purple", "GANGWAR");
                    c.RemoveAllWeapons();
                    c.Dimension = 9999;
        ...
        public void enterKriegsDimension(Player c)
        {
            try
            {
                ...
                if (c.Dimension == dbPlayer.Faction.Dimension)
                {
                    dbPlayer.SendNotification("Du hast die Kriegs Dimension betreten.", 3000, "purple", "KRIEG");
                    c.Dimension = Convert.ToUInt32(1338);
                }
                else
                {
                    dbPlayer.SendNotification("Du hast die Kriegs Dimension verlassen.", 3000, "purple", "KRIEG");
                    c.Dimension = Convert.ToUInt32(dbPlayer.Faction.Dimension);
                }
            }
            catch (Exception ex)
