    ...
    class MazModule : Crimelife.Module.Module<MazModule>
    {
        ...
        public static void loadmaz(MySqlDataReader reader)
        {
            try
            {
                ...
                NAPI.Task.Run(() =>
                {
                    ...
                    val.SetData("MESSAGE", new Message("Benutze E um das MAZ aufzubrechen", "MAZ", "purple", 5000));
        ...
        public void openmaz(Player c, int id, int mazid)
        {
            try
            {
                ...
                {
                    dbplayer.SendNotification("Du besitzt nicht das nötige Item um das MAZ zu öffnen", 3000, "purple", "MAZ");
                    return;
                }
                ...
                NAPI.Task.Run(() =>
                {
                    ...
                    dbPlayer.SendNotification("Kiste erfolgreich geöffnet", 3000, "purple", "MAZ");
