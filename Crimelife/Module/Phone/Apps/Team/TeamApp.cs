    ...
    class TeamApp : Crimelife.Module.Module<TeamApp>
    {
        ...
        public void LeaveFrak(Player c)
        {
            ...
            try
            {
                ...
                dbPlayer.SendNotification("Du hast die Fraktion verlassen.", 3000, "purple", "fraktionssystem");
                dbPlayer.SendNotification("Du hast nun eine Fraksperre (Eine Stunde)", 3000, "purple", "fraktionssystem");
